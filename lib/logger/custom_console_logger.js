...
/*
  ...
  1. LEVELS.OFF & LEVELS.FATAL is same. 
  Only logs automatically generated by node-js are logged. E.g.: 
  Unhandled promise rejection

  2. ERROR: Logs all FATAL + errors

  3. WARN: Logs FATAL, ERROR AND WARNINGS

  4. INFO: Logs FATAL, ERROR , WARNINGS AND INFO

  5. DEBUG: Logs FATAL, ERROR , WARNINGS, INFO & DEBUG

  6. TRACE: Logs FATAL, ERROR , WARNINGS, INFO, DEBUG & TRACES

  7. ALL: Logs All.

  Note: You can set your own custom log level by passing any integer.
  The integer will represent the bit position flag for each log level.
*/
const LOG_LEVELS = {
  /* STANDARD LOG LEVELS */
  OFF           : 0     /* 00000000 */
